...
import { ArrowLeft, Calendar, Twitter, Linkedin, Facebook } from "lucide-react";
            ...
            <div className="max-w-3xl pt-4">
              {article.body ? (
                ...
                <p className="text-xl text-muted-foreground italic">
                  No detailed content provided for this article.
                </p>
              )}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto mt-32 pt-24 border-t border-border">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-xl font-light">
                Highlights and moments captured directly from the field.
              </p>
            </div>
